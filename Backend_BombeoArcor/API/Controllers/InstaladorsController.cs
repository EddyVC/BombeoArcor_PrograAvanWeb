...
namespace API.Controllers
{
    ...
    {
        private readonly example5_SBASAWAPPContext _context;

        public InstaladorsController(example5_SBASAWAPPContext context)
        {
            _context = context;
        }
        ...
        {
            return _context.Instalador.Any(e => e.IdRol == id);
        }
    }
}
